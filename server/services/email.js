    ...
    <tr><td align="center">
      <table width="100%" style="max-width:520px;background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(10,15,31,0.08);">
        ...
        <tr><td style="padding:40px;text-align:center;">
          ...
          <p style="margin:0 0 28px;color:#64748b;font-size:0.9rem;line-height:1.65;">Use the code below to verify your email and complete your Label Flow sign up.</p>
    ...
    <tr><td align="center">
      <table width="100%" style="max-width:520px;background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(10,15,31,0.08);">
        ...
        <tr><td style="padding:40px;">
          ...
          <p style="margin:0 0 28px;color:#64748b;font-size:0.9rem;line-height:1.65;">We received a request to reset the password for your Label Flow account. Click the button below to choose a new password.</p>
